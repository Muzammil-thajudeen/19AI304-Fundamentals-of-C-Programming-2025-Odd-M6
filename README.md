...
```
# Output:
<img width="637" height="400" alt="image" src="https://github.com/user-attachments/assets/92875d6b-0037-4ef5-88c5-76ebc78142a3" />
...
```
# Output:
<img width="582" height="410" alt="image" src="https://github.com/user-attachments/assets/912e21e9-55ab-42fd-9883-a6193fe7e9bc" />
...
```
# Output:
<img width="682" height="848" alt="image" src="https://github.com/user-attachments/assets/f4560064-efd8-4bc2-b19e-90a8e64b7e47" />
...
```
# Output:
<img width="566" height="426" alt="image" src="https://github.com/user-attachments/assets/d97a9e23-a1d6-479b-bdff-49b9b68665b5" />
...
int main()
{
    ...
    /* Assign address of union variable */
    ptr = &var;
...
```
# Output:
<img width="455" height="328" alt="image" src="https://github.com/user-attachments/assets/192fee40-4444-45c5-8b6a-f2dfb9007138" />
